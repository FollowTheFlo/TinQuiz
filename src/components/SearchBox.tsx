...
import { IonItem, IonSearchbar, IonList } from "@ionic/react";
...
const SearchBox: React.FC<{
  ...
  const countryItems = props.countryList
    .slice(0, 5)
    .map((flag) => (
      <SearchItem key={flag.WdCode} flag={flag} selectItem={props.selectItem} />
    ));
  return (
    <span>
      <IonItem>
