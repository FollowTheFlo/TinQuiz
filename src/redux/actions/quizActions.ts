...
const ActionCreators = {
  clearQuizErrorMessage: () => ({ type: CLEAR_QUIZ_ERROR }),
  runDistractor: (payload: RunDistractorPayload) => ({
    type: RUN_DISTRACTOR,
    payload: payload,
  }),

  fillQuiz: (payload: FillQuizPayload) => ({
    type: FILL_QUIZ,
    payload: payload,
  }),
  setQuizId: (payload: SetQuizIdPayload) => ({
    type: SET_QUIZ_ID,
    payload: payload,
  }),
  fillDistractors: (payload: FillDistractorPayload) => ({
    type: FILL_DISTRACTOR,
    payload: payload,
  }),
  fillQuestion: (payload: FillQuestionPayload) => ({
    type: FILL_QUESTION,
    payload: payload,
  }),
  ignoreQuestion: () => ({ type: IGNORE_QUESTION }),
  runQuestion: (params: QuestionParams) => ({
    type: RUN_QUESTION,
    params: params,
  }),
  runQuestionsList: (params: RunQuestionsListParams) => ({
    type: RUN_QUESTIONS_LIST,
    params: params,
  }),
  launchQuiz: (params: LaunchQuizParams) => ({
    type: LAUNCH_QUIZ,
    params: params,
  }),
  ...
  fillFlags: (payload: FillFlagsPayload) => ({
    type: FILL_FLAGS,
    payload: payload,
  }),
  selectFlag: (payload: SelectFlagPayload) => ({
    type: SELECT_FLAG,
    payload: payload,
  }),
};
